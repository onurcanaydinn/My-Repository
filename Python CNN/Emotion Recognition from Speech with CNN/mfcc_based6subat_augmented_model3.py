# -*- coding: utf-8 -*-
"""mfcc_based6subat_augmented_model3.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1S0-oZiB43jShA0FqqyYatt9xnvse2iY3
"""
...
x_train=np.load('/content/drive/MyDrive/data/MFCC_2D_Augmented_default/x_train.npy')
y_train=np.load('/content/drive/MyDrive/data/MFCC_2D_Augmented_default/y_train.npy')
x_valid=np.load('/content/drive/MyDrive/data/MFCC_2D_Augmented_default/x_valid.npy')
y_valid=np.load('/content/drive/MyDrive/data/MFCC_2D_Augmented_default/y_valid.npy')
x_test=np.load('/content/drive/MyDrive/data/MFCC_2D_Augmented_default/x_test.npy')
y_test=np.load('/content/drive/MyDrive/data/MFCC_2D_Augmented_default/y_test.npy')
...
model= Sequential([
                   Conv2D(filters=256, kernel_size=(3,3),activation='relu', padding='same', input_shape=(20,63,1)),
                   #BatchNormalization(),
...
model.save('/content/drive/MyDrive/6subat2D_mfcc_augmented_model3.h5')
